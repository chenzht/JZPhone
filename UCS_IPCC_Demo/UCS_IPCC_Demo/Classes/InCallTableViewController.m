...
static NSString *const kUCSInCallCellData = @"UCSInCallCellData";
...
//+ (bool)isInConference:(UCSCall*) call {
//    if (!call)
//        return false;
...
//}
//
//+ (UCSCall*)retrieveCallAtIndex: (NSInteger) index inConference:(bool) conf{
...
//        if(appData != NULL) {
//            [appData->userInfos removeObjectForKey:kUCSInCallCellData];
//        }
//    }
//}
//
...
//        LinphoneCallAppData* appData = (LinphoneCallAppData*) linphone_call_get_user_pointer(call);
//        if(appData != NULL) {
//            data = [appData->userInfos objectForKey:kUCSInCallCellData];
//            if(data == nil) {
//                data = [[[UICallCellData alloc] init:call minimized:minimized] autorelease];
//                [appData->userInfos setObject:data forKey:kUCSInCallCellData];
//            }
//        }
//    }
//    return data;
//}
//
//- (UICallCellData*)getCallData:(UCSCall*) call {
//    // Handle data associated with the call
//    UICallCellData * data = nil;
//    if(call != NULL) {
//        LinphoneCallAppData* appData = (LinphoneCallAppData*) linphone_call_get_user_pointer(call);
